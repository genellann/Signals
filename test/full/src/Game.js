...
class Game extends Phaser.Game {
    ...
    testTargetObj() {
        ...
        this.signals.registerSignal(Game.TULIP, (obj) => {
            if (!obj.target || !obj.target.hasOwnProperty("test") || obj.target.test !== Game.ROSE || !obj.key ||
                obj.key !== Game.PANSY || !obj.data || !obj.data.hasOwnProperty("test") || obj.data.test !== Game.CARNATION) {
                console.log("Failed");
            } else {
                console.log("Passed");
            }
